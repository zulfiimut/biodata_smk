...
const desaData = {
    "Bangorejo": ["Bangorejo", "Kebondalem", "Sambirejo", "Sambimulyo", "Sukorejo", "Temurejo", "Ringintelu", "Sumberberas", "Wonosobo", "Kedunggebang", "Sumberagung", "Kaliabang"],
    "Banyuwangi": ["Banyuwangi", "Lateng", "Pakis", "Penganjuran", "Karangrejo", "Sobo", "Taman Baru", "Kertosari", "Tukangkayu", "Kepatihan", "Kampung Melayu", "Pendopo", "Singotrunan", "Singonegaran", "Kebalenan", "Banjarsari", "Pengantigan"],
...
const dusunData = {
    ...
    "Blimbingsari": ["Krajan", "Bentengan", "Blimbingsari", "Pecemengan", "Tegalwero"],
        "Blimbingsari": ["Krajan","Bentengan","Blimbingsari","Pecemengan","Tegalwero"],
        "Badean": ["Krajan","KCungkingan","Jatisari"],
        "Bomo": ["Krajan","Jatisari","Kedunen"],
        "Gintangan": ["Krajan","Gumukagung","Kedungbaru","Kedungsari"],
        ...
        "Watukebo": ["Glondong","Krajan","Gepuro","Patoman","Gumuk Agung","Amerthasari"],

    "Cluring": ["Karangrejo", "Trembelang", "Kepatihan", "Cemetuk", "Krajan"],
        "Cluring": ["Karangrejo","Trembelang","Kepatihan","Cemetuk","Krajan"],
        "Benculuk": ["Kebonsari","Kemloso","Krajan","Pancursari","Purwosar"," Rejosari"],
        "Kaliploso": ["Plosorejo","Kalirejo"],
    ...
    "Rogojampi": ["Krajan", "Jagalan", "Lugonto", "Maduran", "Prejengan I", "Prejengan II", "Rogojampi Utara"],
        "Rogojampi": ["Krajan","Jagalan","Lugonto","Maduran","Prejengan I","Prejengan II","Rogojampi Utara","Kauman"],
